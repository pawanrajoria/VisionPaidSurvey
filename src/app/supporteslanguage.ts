export const Iso639Map: Record<string, string> = {
    ...
    ca: "cat", ce: "che", ch: "cha", co: "cos",
    cr: "cre", cs: "ces", cu: "chu", cv: "chv",
    cy: "cym",
    ...
    fa: "fas", ff: "ful", fi: "fin", fj: "fij",
    fo: "fao", fr: "fra", fy: "fry",
    ...
    ta: "tam", te: "tel", tg: "tgk", th: "tha",
    ti: "tir", tk: "tuk", tl: "tgl", tn: "tsn",
